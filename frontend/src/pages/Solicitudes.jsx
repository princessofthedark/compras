...
import { Add, Visibility, Check, Close, Cancel } from '@mui/icons-material';
    ...
    <Box>
      ...
      <Dialog open={openNew} onClose={() => setOpenNew(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          ...
          <TextField select fullWidth label="Categoría" margin="normal" value={form.category}
          ...
          <TextField fullWidth label="Justificación" margin="normal" multiline rows={2}
        ...
        <DialogContent>
          {selected && (
            <Box>
              ...
              <Typography><strong>Categoría:</strong> {selected.category_name}</Typography>
              ...
              <Typography sx={{ mt: 1 }}><strong>Descripción:</strong> {selected.description}</Typography>
              <Typography><strong>Justificación:</strong> {selected.justification}</Typography>
              {selected.exceeds_budget && (
                <Alert severity="warning" sx={{ mt: 1 }}>
                  Esta solicitud excede el presupuesto disponible.
                  {selected.budget_excess_justification && (
                    <Typography variant="body2">Justificación: {selected.budget_excess_justification}</Typography>
                  )}
                </Alert>
              )}
